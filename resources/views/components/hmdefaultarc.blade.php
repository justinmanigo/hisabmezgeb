...
du
{
    ...
    text-decoration-style: double;
        ...
        &emsp;|&emsp;<b><u>Advance Receipt</u></b>
...
<table>
    ...
    Prefix for Advance Receipt Reference Number <br>
    <input type="text" value="AdvRec#-">  <br> 
    like AdvRec#-001, AdvRec#-002, AdvRec#-003 (Auto Increase when Creating new file) <br><br>
    ...
    <form>
        ...
        <select>
            <option>2109 - Other Current Liability</option>
        </select><br><br>
    ...
    <hr><hr><hr><hr><hr><hr><hr>
    <center>
        <hr><hr><b><i><h1>Advance Receipt</h1></i></b> <hr><hr>
    </center>
    <center>
    <table width= 50%>
        <tr>
        ...
        <tr>
            <td>&emsp;&emsp;2109 - Other Current Liability</td>
            <td>_______</td>
            <td><u>2,000.00</u></td>
        </tr>
        <tr>
            <td><b>Total</b></td>
            <td><b><du>2,000.00</du></b></td>
            <td><b><du>2,000.00</du></b></td>
        </tr>
